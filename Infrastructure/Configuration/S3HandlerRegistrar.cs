...
public static class S3HandlerRegistrar {
    public static void AddS3Handlers(this IServiceCollection services) {
        ...
        services.AddScoped<IS3AuthHandler, S3AuthHandler>();
        services.AddScoped<IS3SettingsHandler, S3SettingsHandler>();
        services.AddScoped<IS3ObjectHandler, S3ObjectHandler>();
        services.AddScoped<IS3BucketHandler, S3BucketHandler>();
        services.AddScoped<IBucketStore, DiscordBucketStore>();
